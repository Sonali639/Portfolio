...
function Header(props) {
  ...
  return (
    <Box sx={{ display: "flex" , px:3.6,pt:2.5}}>
  
      <AppBar component="nav" sx={{backgroundColor:"white",boxShadow:"none" ,px:3.6,pt:2.5}}>
        <Toolbar>
        <Typography
            variant="h6"
            color="Black"
          ...
          <IconButton
            ...
            sx={{ display: { xs: "block", sm: "block" } }} // Change this line
          >
            <MenuIcon />
          </IconButton>
